angular.module('nexcast.mypodcastsItem.controllers', [])
  .controller('PodcastsItemCtrl', function($scope, $state, $ionicLoading, $timeout, Player, subscribeService, $stateParams, $http, queueService, $rootScope, hasTagsService, getEpisodesByRSSService) {
